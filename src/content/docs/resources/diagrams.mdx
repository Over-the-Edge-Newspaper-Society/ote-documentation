...
- Mermaid diagrams are automatically rendered using the global mermaid initialization script
- No additional setup is required - just use the `mermaid` code block syntax
- The diagrams will be styled consistently across the site
